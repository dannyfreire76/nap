...
// Path/File: /store/articles/deja-vu.php
// Version: 1.8
// Build: 1801
// Date: 01-24-2007
...
<html>
<head>
<title><?php echo $website_title; ?>: DreamBoost Articles</title>
<?php
...
<?php
$query = "SELECT category, article_name, headline, description, by_line, body, parent_id FROM article WHERE status='1' AND category='1'";
