...
// Path/File: /beta/store/articles/preview.php
// Version: 1.8
// Build: 1801
// Date: 01-26-2007
...
$query = "SELECT category, article_name, headline, subheadline, description, by_line, body, parent_id FROM article WHERE article_id='$article_id'";
