...
// Path/File: /store/two40pillbottle.php
// Version: 1.8
// Build: 1801
// Date: 01-23-2007
...
$query = "SELECT name, url, sub_name, pricing, description, ordering_info, image, image_alt_text, display_on_website, active FROM products WHERE prod_id='9' AND display_on_website='1' AND active='1'";
...
<?php
$query = "SELECT sku, drop_down FROM product_skus WHERE prod_id='9' AND display_on_website='1' AND active='1' ORDER BY prod_sku_id";
$result = mysql_query($query) or die("Query failed : " . mysql_error());
...
<tr><td align="left"><a href="/beta/store/40pillbottle.php"><IMG height="122" alt="One Month Supply of Dream Boost" src="/beta/images/1bottle1.jpg" width="74" border="0"></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="/beta/store/three40pillbottles.php"><IMG height="122" alt="Three Month Supply of Dream Boost" src="/beta/images/3bottles3.jpg" width="143"></a></td></tr>
