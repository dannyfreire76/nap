...
$query = "SELECT name, url, sub_name, pricing, description, ordering_info, image, image_alt_text, display_on_website, active FROM products WHERE prod_id='2' AND display_on_website='1' AND active='1'";
...
<tr><td VALIGN="TOP"><img src="<?php echo $image; ?>" border="0" width="200" height="274" alt="<?php echo $image_alt_text; ?>"></td>
<form action="./cart.php" method="POST">
<td VALIGN="TOP" NOWRAP align="left" class="style2"><?php echo $sub_name; ?><br>
<?php echo $pricing; ?><br>
Quantity <input type="text" name="quantity" size="4" maxlength="4" value="1"><br>
<?php
$query = "SELECT sku, drop_down FROM product_skus WHERE prod_id='2' AND display_on_website='1' AND active='1' ORDER BY prod_sku_id";
$result = mysql_query($query) or die("Query failed : " . mysql_error());
...
</font></td><td>&nbsp;</td><td VALIGN="TOP" align="left" class="style2"><?php echo $ordering_info; if($ordering_info != "") { echo "<br><br>"; } ?>
...
<tr><td align="left"><!--<a href="./5pillbox.php" OnMouseOver="move_in('5tab','../images/but_lrg_5tab_hover.jpg')" OnMouseOut="move_out('5tab','../images/but_lrg_5tab_normal.jpg')"><img src="../images/but_lrg_5tab_normal.jpg" border="0" alt="5 Tablet Box" name="5tab"></a>--> <a href="./40pillbottle.php" OnMouseOver="move_in('40tab','/images/but_lrg_40tab_hover.jpg')" OnMouseOut="move_out('40tab','/images/but_lrg_40tab_normal.jpg')"><img src="/images/but_lrg_40tab_normal.jpg" border="0" alt="40 Tablet Bottle" name="40tab"></a></td></tr>
