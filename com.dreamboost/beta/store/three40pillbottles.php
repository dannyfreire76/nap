...
// Path/File: /store/three40pillbottle.php
// Version: 1.8
// Build: 1801
// Date: 01-23-2007
...
$query = "SELECT name, url, sub_name, pricing, description, ordering_info, image, image_alt_text, display_on_website, active FROM products WHERE prod_id='10' AND display_on_website='1' AND active='1'";
...
<tr><td VALIGN="TOP" align="left"><img src="<?php echo $image; ?>" border="0" width="151" height="249" alt="<?php echo $image_alt_text; ?>"></td>
...
<?php
$query = "SELECT sku, drop_down FROM product_skus WHERE prod_id='10' AND display_on_website='1' AND active='1' ORDER BY prod_sku_id";
$result = mysql_query($query) or die("Query failed : " . mysql_error());
...
<tr><td align="left"><a href="/beta/store/40pillbottle.php"><IMG height="122" alt="One Month Supply of Dream Boost" src="/beta/images/1bottle1.jpg" width="74" border="0"></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="/beta/store/two40pillbottles.php"><IMG height="122" alt="Two Month Supply of Dream Boost" src="/beta/images/2bottles2.jpg" width="143"></a></td></tr>
