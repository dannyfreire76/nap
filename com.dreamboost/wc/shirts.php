...
$query = "SELECT name, url, sub_name, pricing, wholesale_pricing1, description, ordering_info, image, image_alt_text, display_in_wc, active FROM products WHERE prod_id='$product_id' AND display_in_wc='1' AND active='1'";
...
$query = "SELECT name FROM product_categories WHERE prod_cat_id='5' AND display_in_wc='1' AND active='1'";
$result = mysql_query($query) or die("Query failed : " . mysql_error());
while ($line = mysql_fetch_array($result, MYSQL_ASSOC)) {
	$cat_name = $line["name"];
}
...
<tr><td align="center" VALIGN="TOP"><a href="./shirts2.php"><img src="<?php echo $image; ?>" border="0" width="200" height="228" alt="<?php echo $image_alt_text; ?>"></a><br>
<font face="<?php echo $font; ?>" color="#<?php echo $fontcolor; ?>" size="4"><a href="./shirts2.php">Click to Enlarge</a></font>
</td>
...
<tr><td><font face="<?php echo $font; ?>" color="#<?php echo $fontcolor; ?>" size="2">Suggested Retail</font></td><td align="center"><font face="<?php echo $font; ?>" color="#<?php echo $fontcolor; ?>" size="2">$<?php echo $cost[0]; ?></font></td></tr>
<tr><td><font face="<?php echo $font; ?>" color="#<?php echo $fontcolor; ?>" size="2">Wholesale</font></td><td align="center"><font face="<?php echo $font; ?>" color="#<?php echo $fontcolor; ?>" size="2">$<?php echo $wholesale_cost1[0]; ?></font></td></tr>
</table>
...
<tr><td align="left"><font face="<?php echo $font; ?>" color="#<?php echo $fontcolor; ?>" size="4">Coming Soon!</font></td></tr>
