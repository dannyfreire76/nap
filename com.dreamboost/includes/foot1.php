...
//include_once($thisSite["site_key_name"].'/'.$thisSite["site_key_name"].'_foot1.php');
?>
<?php
	...
	<!-- foot1... -->
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="9" style="height:110px;">
			<tr valign="bottom">
				...
				<td>&nbsp;</td>
				<td align="right" class="footerNav"><strong><a href="<?=$base_url?>store/index.php">Order Dream Boost</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="<?=$base_url?>ingredients.php">Ingredients</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="<?=$base_url?>faqs/index.php">FAQs</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="<?=$base_url?>about/index.php">About Us</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="<?=$base_url?>contact/index.php">Contact Us</a></strong></td>
			</tr>
		</table>
		<!-- end #footer -->
		</div>
