...
//include_once($thisSite["site_key_name"].'/'.$thisSite["site_key_name"].'_head1.php');
?>
<?php 
// BME WMS 
...
if(  $_SESSION["rep_id"] != "" ) {
	...
	<script type="text/javascript">
		$('body').css('background-color','#c3c5ee');
	</script>
	<div id="container">
		<div id="header">
					...
					<td width="350" align="right" valign="top">
						<div id="navMenu">
							<ul>
								...
								<li><a href="<?=$base_url?>store/index.php">Order Dream Boost</a></li>
		...
		<div id="sidebar">
			...
			<ul>
				...
				<li class="sidebarNav"><a href="<?=$base_url?>lucid_dream/index.php">Lucid Dreaming</a></li>
...
<?php /*?>				<li class="sidebarNav">Listen to a recent <a href="http://www.smodcast.com/" title="SMODCAST"><img src="<?=$base_url?>images/SMODCAST.jpg" alt="SMODCAST" style="height: 34px; width: 120px;"></a> about <?=$product_name?>  <object type="application/x-shockwave-flash" data="http://tinycomet.com/audio/player.swf" id="audioplayer1" width="290" height="24">
			...
			<img src="<?=$base_url?>images/bg/img_sidebarbot2.png" width="190" height="90" style="margin:9px 0 -18px 0;" /></div>
		<!-- end #sidebar -->
		<div id="mainContent">
	<!-- ...head2 -->
<?php
