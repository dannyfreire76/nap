...
(function($) {
	...
	return this.each(function() {
		...
		dockClass: 'docked',
		// class name for docked splitter
		pxPerKey: 8,
		...
		var isDocked = 0,
		    undock_timer;
		splitter.bind("toggleDock", function() {
		    ...
		    bar._pos = pw;
		    var x = {};
		    x[opts.origin] = 0; // splitter[0][opts.pxSplit] - splitter._PBA - bar[0][opts.pxSplit];
		    ...
		    bar.removeClass(opts.dockClass).animate(x, opts.undockSpeed || opts.dockSpeed || 1, opts.undockEasing || opts.dockEasing, function() {
			resplit(bar._pos);
		    });
		});
