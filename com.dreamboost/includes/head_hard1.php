  ...
  <TR>
    ...
    <TD vAlign="top" width="628" align="center">
      <TABLE width="797" border="0">
        <TBODY>
        <TR>
          <TD vAlign="top" align="center" colSpan="7"><a href="<?php echo $base_url; ?>index.php"><IMG height="76" alt="Dream Boost Sleep Aid and Dream Enhancer" src="../images/headerDreamBoost.jpg" width="791" border="0"></a></TD></TR>
        <TR>
        ...
        <TR vAlign="top" align="center">
          <TD width="77"><A 
            ...
            href="<?php echo $base_url; ?>store/index.php"><IMG height="39" 
            alt="Store" 
          ...
          <TD width="150"><A 
            ...
            onmouseout="MM_swapImgRestore()" 
            href="<?php echo $base_url; ?>lucid_dream/index.php"><IMG height="38" 
            alt="Lucid Dreaming" 
          ...
          <TD width="124"><A 
            ...
            onmouseout="MM_swapImgRestore()" 
            href="<?php echo $base_url; ?>directions/index.php"><IMG height="38" 
            alt="Suggestions" 
          ...
          <TD width="158"><A 
            ...
            onmouseout="MM_swapImgRestore()" 
            href="<?php echo $base_url; ?>supplement-facts/index.php"><IMG height="38" 
          ...
          <TD width="124"><A 
            ...
            onmouseout="MM_swapImgRestore()" 
            href="<?php echo $base_url; ?>testimonials/index.php"><IMG height="38" 
            alt="Testimonials" 
          ...
          <TD width="76"><A 
            ...
            onmouseout="MM_swapImgRestore()" 
            href="<?php echo $base_url; ?>faqs/index.php"><IMG height="39" alt="FAQs" 
            src="../images/faqs.gif" 
            width="67" border="0" name="FAQs"></A></TD>
          <TD width="78"><A 
            onmouseover="MM_swapImage('Contact','','../images/contact_over.gif',1)" 
            onmouseout="MM_swapImgRestore()" 
            href="<?php echo $base_url; ?>contact/index.php"><IMG height="38" 
            alt="Contact" 
