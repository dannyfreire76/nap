<?php
// BME WMS
// Page: Products Manager - Create Product Category page
// Path/File: /admin/products_admin8.php
// Version: 1.8
// Build: 1808
// Date: 03-25-2007
...
$manager = "products";
$page = "Products Manager > Create Product Categories";
...
<tr><td align="left"><font size="2">On this page you can create a Product Category.</font></td></tr>
...
<tr><td align="left">
	<FORM name="products" Method="POST" ACTION="./products_admin8.php" class="wmsform">
	...
	<fieldset>
		...
		<ol>
			...
			<li class="fm-button">
				<input type="submit" id="create" name="create" value="Create Product Category">
			</li>
		</ol>
	</fieldset>
	</form>
