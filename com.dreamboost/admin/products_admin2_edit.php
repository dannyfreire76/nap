<?php
// BME WMS
// Page: Products Manager - Edit Product SKU page
// Path/File: /admin/products_admin2_edit.php
// Version: 1.8
// Build: 1805
// Date: 03-17-2007
...
$manager = "products";
$page = "Products Manager > Edit Product SKUs";
...
if($edit) {
	...
	if($error_txt == "") {
		$query = "UPDATE product_skus SET sku='$sku', name='$name', drop_down='$drop_down', ship_con_id='$ship_con_id', cost='$cost', wholesale_cost1='$wholesale_cost1', wholesale_cost2='$wholesale_cost2', wholesale_cost3='$wholesale_cost3', dist_cost1='$dist_cost1', dist_cost2='$dist_cost2', dist_cost3='$dist_cost3', weight_lbs='$weight_lbs', weight_ozs='$weight_ozs', stock_status='$stock_status', stock='$stock', display_on_website='$display_on_website', display_in_wc='$display_in_wc', active='$active', threshold='$threshold', weight='$weight_gms' WHERE prod_sku_id='$prod_sku_id'";
...
<tr><td align="left"><font size="2">Edit the Product SKU below.</font></td></tr>
...
$query = "SELECT * FROM product_skus WHERE prod_sku_id='$prod_sku_id'";
$result = mysql_query($query) or die("Query failed : " . mysql_error());
while ($line = mysql_fetch_array($result, MYSQL_ASSOC)) {
	...
	$sku = $line["sku"];
	$name = $line["name"];
	$drop_down = $line["drop_down"];
	$ship_con_id = $line["ship_con_id"];
	$cost = $line["cost"];
	...
	$weight_gms = $line["weight"];
	$weight_lbs = $line["weight_lbs"];
	$weight_ozs = $line["weight_ozs"];
...
<tr><td align="left">
	<FORM name="products" Method="POST" ACTION="./products_admin2_edit.php" class="wmsform">
	<input type="hidden" name="prod_sku_id" value="<?php echo $prod_sku_id; ?>">
	...
	<fieldset>
		...
		<ol>
			...
			<li>
				...
				<INPUT type="text" id="sku" name="sku" size="10" value="<?php echo $sku; ?>" tabindex="1" />
			</li>
			<li>
	...
	<fieldset>
		...
		<ol>
			<li>
				<label for="weight_lbs">Weight (Grams) <em>*</em></label>
				<INPUT type="text" id="weight_gms" name="weight_gms" size="5" value="<?php echo $weight_gms; ?>" tabindex="12" />
			</li>
			<li>
				<label for="weight_lbs">Weight (Pounds) <em>*</em></label>
				<INPUT type="text" id="weight_lbs" name="weight_lbs" size="5" maxlength="5" value="<?php echo $weight_lbs; ?>" tabindex="12" />
			</li>
			<li>
				<label for="weight_ozs">Weight (Ounces) <em>*</em></label>
				<INPUT type="text" id="weight_ozs" name="weight_ozs" size="5" maxlength="5" value="<?php echo $weight_ozs; ?>" tabindex="13" />
			</li>
			<li>
				<label for="stock_status">Stock Status <em>*</em></label>
				<select id="stock_status" name="stock_status" tabindex="14">
			...
			<li>
				...
				<INPUT type="text" id="stock" name="stock" size="5" maxlength="11" value="<?php echo $stock; ?>" tabindex="15" />
			</li>
			<li>
				<label for="threshold">Stock Threshold <em>*</em></label>
				<INPUT type="text" id="threshold" name="threshold" size="2" maxlength="2" value="<?php echo $threshold; ?>" tabindex="16" />
			</li>
			<li>
				<label for="display_on_website">Display on Website <em>*</em></label>
				<select id="display_on_website" name="display_on_website" tabindex="17">
			...
			<li>
				...
				<select id="display_in_wc" name="display_in_wc" tabindex="18">
			...
			<li>
				...
				<select id="active" name="active" tabindex="19">
			...
			<li class="fm-button">
				<input type="submit" id="edit" name="edit" value="Edit Product SKU">
			</li>
		</ol>
	</fieldset>
	</form>
