<?php
// BME WMS
// Page: Testimonial Manager Manage Rejected Testimonials page
// Path/File: /admin/testimonials_admin3.php
// Version: 1.8
// Build: 1805
// Date: 05-14-2007
...
$page = "Testimonials Manager > Manage Rejected Testimonials";
$url = "testimonials_admin3.php";
...
<tr><td align="left"><font size="2">These are the testimonials that have been rejected. You can always edit these further and turn them into something usable for the site and then approve them. Or just leave them as rejected.</font></td></tr>
...
<?php
$query = "SELECT count(*) as count FROM testimonials WHERE status='2'";
$result = mysql_query($query) or die("Query failed : " . mysql_error());
while ($line = mysql_fetch_array($result, MYSQL_ASSOC)) {
...
$line_counter = 0;
$query = "SELECT testimonial_id, created, name, email, address1, address2, city, state, zip, country, phone, fax, testimonial, product FROM testimonials WHERE status='2' ORDER BY created LIMIT $record_start,$limit";
$result = mysql_query($query) or die("Query failed : " . mysql_error());
while ($line = mysql_fetch_array($result, MYSQL_ASSOC)) {
	$line_counter++;
	...
	echo "</font></td><input type=\"hidden\" name=\"testimonial_id\" value=\"";
	echo $line["testimonial_id"];
	echo "\"><td align=\"center\"><input type=\"image\" src=\"/images/wms/edit.gif\" id=\"edit\" name=\"edit\" width=\"16\" height=\"16\" alt=\"Edit\"></td></tr></form>\n";
}
mysql_free_result($result);
?>
</table></td></tr>
