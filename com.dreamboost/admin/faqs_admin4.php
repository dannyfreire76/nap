<?php
// BME WMS
// Page: FAQS To Be Reviewed page
// Path/File: /admin/faqs_admin4.php
// Version: 1.8
// Build: 1804
// Date: 01-23-2007
...
$manager = "faqs";
$page = "FAQs Manager > Manage FAQs To Be Reviewed";
...
<?php
$query = "SELECT faq_category_id, category_name FROM faqs_categories ORDER BY position";
...
?>
	...
	<?php
	$line_counter = 0;
	$query2 = "SELECT faqs_id, status, position, category, question, answer FROM faqs WHERE status='0' AND category='$faq_category_id' ORDER BY position";
	...
	while ($line2 = mysql_fetch_array($result2, MYSQL_ASSOC)) {
		...
		echo "<FORM Method=\"POST\" ACTION=\"./faqs_admin4_edit.php\" class=\"wmsform\">\n";
		echo "<tr";
