<?php
// BME WMS
// Page: Content Articles To Be Reviewed page
// Path/File: /admin/content_admin4.php
// Version: 1.8
// Build: 1803
// Date: 01-22-2007
...
$manager = "content";
$page = "Content Manager > Manage Articles To Be Reviewed";
...
<tr><td align="left"><font size="2">These are the Content Articles waiting to be reviewed - you can edit or remove them below.</font></td></tr>
...
while ($line = mysql_fetch_array($result, MYSQL_ASSOC)) {
	...
	<?php
	$line_counter = 0;
	$query2 = "SELECT article_id, status, position, category, article_name, headline FROM article WHERE status='2' AND category='$article_category_id' ORDER BY position";
	...
	while ($line2 = mysql_fetch_array($result2, MYSQL_ASSOC)) {
		...
		echo "<FORM name=\"content-manage\" Method=\"POST\" ACTION=\"./content_admin4_edit.php\" class=\"wmsform\">\n";
		echo "<tr";
