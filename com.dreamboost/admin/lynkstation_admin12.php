<?php
// BME WMS
// Page: LynkStation No Reciprocal Links page
// Path/File: /admin/lynkstation_admin12.php
// Version: 1.8
// Build: 1803
// Date: 01-22-2007
...
$manager = "lynkstation";
$page = "LynkStation Manager > Manage No Reciprocal Links";
...
<tr><td align="left"><font size="2">These are the website no reciprocal links submitted on the site, you can edit and then approve or reject them below. An email will be sent to the user as you complete each one.</font></td></tr>
...
echo "<tr><form action=\"./lynkstation_admin12.php\" method=\"POST\"><td align=\"left\"><font size=\"2\"><b>Category:</b> </font><select name=\"category\">";
...
$query = "SELECT lslinks_id, approved, title, website_url, description, email, category, reciprical_link FROM lynkstation_links WHERE approved='4' AND category='$category' ORDER BY modified";
$result = mysql_query($query) or die("Query failed : " . mysql_error());
while ($line = mysql_fetch_array($result, MYSQL_ASSOC)) {
	echo "<tr><form action=\"./lynkstation_admin5.php\" method=\"POST\"><td><SELECT name=\"approved\">";
	echo "<option value=\"0\"";
