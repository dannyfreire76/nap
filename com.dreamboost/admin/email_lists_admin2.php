<?php
// BME WMS
// Page: Email Lists Manage Subscribers page
// Path/File: /admin/email_lists_admin2.php
// Version: 1.8
// Build: 1804
// Date: 02-07-2007
...
$manager = "email_lists";
$page = "E-Mail Lists Manager > Manage Subscribed Users";
$url = "email_lists_admin2.php";
...
<tr><td align="left"><font size="2">Welcome to the E-Mail Lists Manager, where you manage the E-Mail Newsletter section of your website. On this page you manage the subscribed users to your newsletter.</font></td></tr>
...
<?php
$query = "SELECT count(*) as count FROM news_member WHERE status='1'";
$result = mysql_query($query) or die("Query failed : " . mysql_error());
...
$line_counter = 0;
$query = "SELECT member_id, status, name, email FROM news_member WHERE status='1' ORDER BY modified LIMIT $record_start,$limit";
$result = mysql_query($query) or die("Query failed : " . mysql_error());
while ($line = mysql_fetch_array($result, MYSQL_ASSOC)) {
	$line_counter++;
	$line_this = $line_counter / 2;
	echo "<FORM Method=\"POST\" ACTION=\"./email_lists_admin2.php?page_this=";
	echo $page_this;
	echo "\" class=\"wmsform\">\n";
	echo "<tr";
