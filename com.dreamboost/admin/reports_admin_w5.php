...
$manager = "reports";
$page = "Reports Manager > Wholesale > Monthly Sales Report";
...
<tr><td align="left"><font size="2">Welcome to the Reports Manager Monthly Wholesale Sales Report. This page reports all the Monthly Wholesale sales that have been transacted through the website.</font></td></tr>
</form>
<tr><td>&nbsp;</td></tr>

<tr><td align="left"><table class="maintable" cellspacing="0">
<tr><th scope="col">Date</th><th scope="col">Sub-Total</th><th scope="col">Tax</th><th scope="col">Shipping</th><th scope="col">Discount</th><th scope="col">Grand Total</th><th scope="col">Orders</th><th scope="col">Average Order</th></tr>
