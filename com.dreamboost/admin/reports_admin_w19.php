<?php
// BME WMS
// Page: Reports Monthly Profit Analysis Sales page
// Path/File: /admin/reports_admin_w19.php
// Version: 1.8
// Build: 1803
// Date: 01-22-2007
...
$manager = "reports";
$page = "Reports Manager > Wholesale > Monthly Profit Analysis Report";
...
<tr><td align="left"><font size="2">Welcome to the Reports Manager Monthly Wholesale Profit Analysis Sales Report. This page reports the revenue, cost, and profit of all the Monthly Wholesale sales that have been transacted through the website.</font></td></tr>

<form action="./reports_admin_w19.php" method="POST">
...
for ( $query_year=2004; $query_year<=date("Y"); $query_year++  ) {
	for ( $query_month=1; $query_month < 13; $query_month++  ) {
		...
		if($tmp_quantity != 0) {
			...
			echo "<a href=\"./reports_admin_w21.php?date=$date\">";
			echo $date;
			echo "</a></font></td><td align=\"center\"><font face=\"Verdana\" size=\"+1\">";
			echo $tmp_quantity;
