<?php
// BME WMS
// Page: Content Manager Manage Articles page
// Path/File: /admin/content_admin2.php
// Version: 1.8
// Build: 1805
// Date: 01-31-2007
...
$manager = "content";
$page = "Content Manager > Manage Live Articles";
...
<tr><td align="left"><font size="2">These are the Articles of Content being displayed on the site now - you can edit or remove them below.</font></td></tr>
...
<?php
$query = "SELECT article_category_id, category_name, site_path FROM article_categories WHERE status='1' ORDER BY position";
$result = mysql_query($query) or die("Query failed : " . mysql_error());
while ($line = mysql_fetch_array($result, MYSQL_ASSOC)) {
	$category_name = $line["category_name"];
	$article_category_id = $line["article_category_id"];
	$site_path = $line["site_path"];
	...
	<?php
	$line_counter = 0;
	$query2 = "SELECT article_id, status, position, category, article_name, headline FROM article WHERE status='1' AND category='$article_category_id' ORDER BY position";
	...
	while ($line2 = mysql_fetch_array($result2, MYSQL_ASSOC)) {
		...
		echo "<FORM name=\"content-manage\" Method=\"POST\" ACTION=\"./content_admin2_edit.php\" class=\"wmsform\">\n";
		echo "<tr";
		...
		echo "\"><td><a href=\"".$base_url.$site_path."/article_id/";
		echo $line2["article_id"];
