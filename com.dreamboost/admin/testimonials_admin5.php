<?php
// BME WMS
// Page: Testimonial Manager Manage Live Testimonials page
// Path/File: /admin/testimonials_admin5.php
// Version: 1.8
// Build: 1805
// Date: 05-14-2007
...
$page = "Testimonials Manager > Manage Live Testimonials";
$url = "testimonials_admin5.php";
wms_manager_nav2($manager);
wms_page_nav2($manager);

if($update != "") {
	$query = "UPDATE testimonials SET position='$position' WHERE testimonial_id='$testimonial_id'";
	$result = mysql_query($query) or die("Query failed : " . mysql_error());
} elseif($edit != "") {
	//Redirect to Manage Live Testimonials Edit page
	header("Location: " . $base_url . "admin/testimonials_admin2_edit.php?id=" . $testimonial_id);
	exit;
...
<tr><td align="left"><font size="2">Welcome to the Testimonials Manager, where you manage the testimonials section of your website. These are the testimonials being <a href="<?php echo $base_url; ?>testimonials/index.php" TARGET="_BLANK">displayed on the site now</a> you can edit or remove them below.</font></td></tr>
...
<tr><th scope="col">Position</th><th scope="col">Created</th><th scope="col">Name</th><th scope="col">Displayed Testimonial</th><th scope="col">&nbsp;</th></tr>

<?php
$query = "SELECT count(*) as count FROM testimonials WHERE status='1'";
$result = mysql_query($query) or die("Query failed : " . mysql_error());
while ($line = mysql_fetch_array($result, MYSQL_ASSOC)) {
...
$line_counter = 0;
$query = "SELECT testimonial_id, created, position, name, email, address1, address2, city, state, zip, country, phone, fax, testimonial, product FROM testimonials WHERE status='1' ORDER BY position LIMIT $record_start,$limit";
$result = mysql_query($query) or die("Query failed : " . mysql_error());
while ($line = mysql_fetch_array($result, MYSQL_ASSOC)) {
	$line_counter++;
	...
	echo "<form name=\"testimonials-manage\" Method=\"POST\" action=\"./testimonials_admin5.php?page_this=";
	echo $page_this;
	echo "\" class=\"wmsform\">";
	echo "<tr";
	...
	echo "\"><td><input type=\"submit\" id=\"update\" name=\"update\" value=\"Update Position\"> ";
	echo "<input type=\"submit\" id=\"edit\" name=\"edit\" value=\"Edit Testimonial\"></td></tr>\n";
	echo "</form>\n";
}
mysql_free_result($result);
?>
