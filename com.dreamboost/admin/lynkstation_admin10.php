<?php
// BME WMS
// Page: LynkStation Manage Rejected Links page
// Path/File: /admin/lynkstation_admin10.php
// Version: 1.8
// Build: 1803
// Date: 01-22-2007
...
$manager = "lynkstation";
$page = "LynkStation Manager > Manage Rejected Links";
...
<tr><td align="left"><font size="2">These are the links that have been rejected from the site. You can edit any of them at any time and put them back on to the website. To move a link from one category to another you would change the category on the website listing below and then click edit for it's entry.</font></td></tr>
...
echo "<tr><form action=\"./lynkstation_admin10.php\" method=\"POST\"><td align=\"left\"><font size=\"2\"><b>Category:</b> </font><select name=\"category\">";
...
$query = "SELECT lslinks_id, approved, title, website_url, description, email, category, reciprical_link FROM lynkstation_links WHERE approved='2' AND category='$category' ORDER BY modified DESC";
$result = mysql_query($query) or die("Query failed : " . mysql_error());
while ($line = mysql_fetch_array($result, MYSQL_ASSOC)) {
	echo "<tr><form action=\"./lynkstation_admin10.php\" method=\"POST\"><td><SELECT name=\"approved\">";
	echo "<option value=\"0\"";
