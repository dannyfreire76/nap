...
//
//********  Change History
// 2/24/2009: Changed CURLOPT_TIMEOUT from 360 to 60
//********  
...
##########################################################################
	...
	// Access Passwords
	var $AccessLicenseNumber='1BFDA61E861DB1B4';
	var $UserId='salviazo';
	var $Password='mazatec';

	// Pickup Service You have
	var $UPSPickupTypeCode='03';

	// CustomerContext can contain XML you want Posted Back
	var $CustomerContext='UPS Version 0.4: (PHP/cURL-XML)';


	// Address of Shipper.  should match info givin to ups
	var $ShipperCity='Ithaca';
	var $ShipperState='NY';
	var $ShipperPostalCode='13068';
	var $ShipperCountry='US';

	// Address package is shipped from, use if different than above
	var $ShipFromCity='Ithaca';
	var $ShipFromState='NY';
	var $ShipFromPostalCode='13068';
...
#################################################################################################
## CreateRequest - assembles the XML request
#################################################################################################
...
###############################################################################################
	...
	function Process()
	{
		...
		// TELL cURL WHEN TO TIME OUT (in seconds)
