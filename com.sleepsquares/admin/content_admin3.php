<?php
// BME WMS
// Page: Content Create Article page
// Path/File: /admin/content_admin3.php
// Version: 1.8
// Build: 1805
// Date: 02-05-2007
...
$manager = "content";
$page = "Content Manager > Create New Articles";
...
<tr><td align="left"><font size="2">Please use the form below to create a new Article.</font></td></tr>
...
<tr><td align="left">
	<FORM name="content" Method="POST" ACTION="./content_admin3.php" class="wmsform">
	...
	<fieldset>
		...
		<ol>
			...
			<li class="fm-button">
				<input type="submit" id="submit" name="submit" value="Create Article">
			</li>
		</ol>
	</fieldset>
	</form>
