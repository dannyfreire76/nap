...
// Path/File: /admin/reports_admin_r5.php
// Version: 1.8
// Build: 1804
// Date: 05-14-2007
...
$manager = "reports";
$page = "Reports Manager > Retail > Monthly Sales Report";
...
<tr><td align="left"><font size="2">Welcome to the Reports Manager Retail Monthly Sales Report. This page reports all the Monthly Retail sales that have been transacted through the website.</font></td></tr>
</form>
<tr><td>&nbsp;</td></tr>
...
for ( $query_year=2004; $query_year<=date("Y"); $query_year++  ) {
	for ( $query_month=1; $query_month < 13; $query_month++  ) {
		...
		$line_counter = 0;
		$query = "SELECT subtotal, complete, tax, shipping FROM receipts WHERE complete='1' $date2";
