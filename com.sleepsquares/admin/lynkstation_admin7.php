<?php
// BME WMS
// Page: LynkStation Bad Links page
// Path/File: /admin/lynkstation_admin7.php
// Version: 1.8
// Build: 1803
// Date: 01-22-2007
...
$manager = "lynkstation";
$page = "LynkStation Manager > Manage Bad Links";
...
<tr><td align="left"><font size="2">These links that have been submitted, but they are bad because the website they point to is not working. You can check them, edit and then approve or reject them below. An email will be sent to the user as you complete each one.</font></td></tr>
...
<?php
$query = "SELECT lslinks_id, approved, title, website_url, description, email, category, reciprical_link FROM lynkstation_links WHERE approved='3' ORDER BY modified";
$result = mysql_query($query) or die("Query failed : " . mysql_error());
while ($line = mysql_fetch_array($result, MYSQL_ASSOC)) {
	echo "<tr><form action=\"./lynkstation_admin7.php\" method=\"POST\"><td><SELECT name=\"approved\">";
	echo "<option value=\"0\"";
	...
	echo "<tr><td colspan=\"3\"><font size=\"2\">Category: </font><select name=\"category\">";
	...
	mysql_free_result($result2);
	echo "</select></td><td colspan=\"2\"><font size=\"2\">Reciprocal Link: </font><input type=\"text\" name=\"reciprical_link\" size=\"21\" maxlength=\"150\" value=\"";
