<?php
// BME WMS
// Page: LynkStation To be Approved page
// Path/File: /admin/lynkstation_admin5.php
// Version: 1.8
// Build: 1805
// Date: 02-19-2007
...
$manager = "lynkstation";
$page = "LynkStation Manager > Approve/Reject Submitted Links";
...
<tr><td align="left"><font size="2">These are the website links recently submitted on the site, you can edit and then approve or reject them below. An e-mail will be sent to the user as you complete each one.</font></td></tr>
...
<?php
$query = "SELECT lslinks_id, approved, title, website_url, description, email, category, reciprical_link FROM lynkstation_links WHERE approved='0' ORDER BY modified";
$result = mysql_query($query) or die("Query failed : " . mysql_error());
while ($line = mysql_fetch_array($result, MYSQL_ASSOC)) {
