...
if($manager != "callcenter"){
	$manager = "members";
	$page = "Orders Manager > Recurring Orders Queue";
}else{
	$page = "Call Center Manager > Recurring Orders Queue";
}
...
<tr><td align="left"><font size="2">Welcome to the <?=$page?> page, where you view pending recurring member orders.
</font></td></tr>
