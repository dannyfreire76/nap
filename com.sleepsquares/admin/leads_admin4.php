<?php
// BME WMS
// Page: Leads Modify Lead page
// Path/File: /admin/leads_admin4.php
// Version: 1.8
// Build: 1803
// Date: 01-22-2007
...
if ($submit != "") {
	...
	$query .= " WHERE leads_id='$leads_id'";
	$result = mysql_query($query) or die("Query failed : " . mysql_error());
	
	
	$query = "SELECT retailer_type_id FROM leads_type_link WHERE leads_id='$leads_id' AND retailer_type_id='1'";
	$result = mysql_query($query) or die("Query failed : " . mysql_error());
	while ($line = mysql_fetch_array($result, MYSQL_ASSOC)) {
		$temp_retailer_type_id1 = $line["retailer_type_id"];
	}
	mysql_free_result($result);
	if($retailer_type1 == 1 && $temp_retailer_type_id1 == "") {
		$now = date("Y-m-d H:i:s");
		$query = "INSERT INTO leads_type_link SET created='$now', leads_id='$leads_id', retailer_type_id='1'";
		$result = mysql_query($query) or die("Query failed : " . mysql_error());
	}
	if($retailer_type1 != 1 && $temp_retailer_type_id1 == 1) {
		$query = "DELETE FROM leads_type_link WHERE leads_id='$leads_id' AND retailer_type_id='1'";
		$result = mysql_query($query) or die("Query failed : " . mysql_error());
	}
	
	$query = "SELECT retailer_type_id FROM leads_type_link WHERE leads_id='$leads_id' AND retailer_type_id='2'";
	$result = mysql_query($query) or die("Query failed : " . mysql_error());
	while ($line = mysql_fetch_array($result, MYSQL_ASSOC)) {
		$temp_retailer_type_id2 = $line["retailer_type_id"];
	}
	mysql_free_result($result);
	if($retailer_type2 == 1 && $temp_retailer_type_id2 == "") {
		$now = date("Y-m-d H:i:s");
		$query = "INSERT INTO leads_type_link SET created='$now', leads_id='$leads_id', retailer_type_id='2'";
		$result = mysql_query($query) or die("Query failed : " . mysql_error());
	}
	if($retailer_type2 != 1 && $temp_retailer_type_id2 == 2) {
		$query = "DELETE FROM leads_type_link WHERE leads_id='$leads_id' AND retailer_type_id='2'";
		$result = mysql_query($query) or die("Query failed : " . mysql_error());
	}
	
	$query = "SELECT retailer_type_id FROM leads_type_link WHERE leads_id='$leads_id' AND retailer_type_id='3'";
	$result = mysql_query($query) or die("Query failed : " . mysql_error());
	while ($line = mysql_fetch_array($result, MYSQL_ASSOC)) {
		$temp_retailer_type_id3 = $line["retailer_type_id"];
	}
	mysql_free_result($result);
	if($retailer_type3 == 1 && $temp_retailer_type_id3 == "") {
		$now = date("Y-m-d H:i:s");
		$query = "INSERT INTO leads_type_link SET created='$now', leads_id='$leads_id', retailer_type_id='3'";
		$result = mysql_query($query) or die("Query failed : " . mysql_error());
	}
	if($retailer_type3 != 1 && $temp_retailer_type_id3 == 3) {
		$query = "DELETE FROM leads_type_link WHERE leads_id='$leads_id' AND retailer_type_id='3'";
		$result = mysql_query($query) or die("Query failed : " . mysql_error());
	}
	
	$query = "SELECT retailer_type_id FROM leads_type_link WHERE leads_id='$leads_id' AND retailer_type_id='4'";
	$result = mysql_query($query) or die("Query failed : " . mysql_error());
	while ($line = mysql_fetch_array($result, MYSQL_ASSOC)) {
		$temp_retailer_type_id4 = $line["retailer_type_id"];
	}
	mysql_free_result($result);
	if($retailer_type4 == 1 && $temp_retailer_type_id4 == "") {
		$now = date("Y-m-d H:i:s");
		$query = "INSERT INTO leads_type_link SET created='$now', leads_id='$leads_id', retailer_type_id='4'";
		$result = mysql_query($query) or die("Query failed : " . mysql_error());
	}
	if($retailer_type4 != 1 && $temp_retailer_type_id4 == 4) {
		$query = "DELETE FROM leads_type_link WHERE leads_id='$leads_id' AND retailer_type_id='4'";
		$result = mysql_query($query) or die("Query failed : " . mysql_error());
	}
	
	$query = "SELECT retailer_type_id FROM leads_type_link WHERE leads_id='$leads_id' AND retailer_type_id='5'";
	$result = mysql_query($query) or die("Query failed : " . mysql_error());
	while ($line = mysql_fetch_array($result, MYSQL_ASSOC)) {
		$temp_retailer_type_id5 = $line["retailer_type_id"];
	}
	mysql_free_result($result);
	if($retailer_type5 == 1 && $temp_retailer_type_id5 == "") {
		$now = date("Y-m-d H:i:s");
		$query = "INSERT INTO leads_type_link SET created='$now', leads_id='$leads_id', retailer_type_id='5'";
		$result = mysql_query($query) or die("Query failed : " . mysql_error());
	}
	if($retailer_type5 != 1 && $temp_retailer_type_id5 == 5) {
		$query = "DELETE FROM leads_type_link WHERE leads_id='$leads_id' AND retailer_type_id='5'";
		$result = mysql_query($query) or die("Query failed : " . mysql_error());
	}
	
	$query = "SELECT retailer_type_id FROM leads_type_link WHERE leads_id='$leads_id' AND retailer_type_id='6'";
	$result = mysql_query($query) or die("Query failed : " . mysql_error());
	while ($line = mysql_fetch_array($result, MYSQL_ASSOC)) {
		$temp_retailer_type_id6 = $line["retailer_type_id"];
	}
	mysql_free_result($result);
	if($retailer_type6 == 1 && $temp_retailer_type_id6 == "") {
		$now = date("Y-m-d H:i:s");
		$query = "INSERT INTO leads_type_link SET created='$now', leads_id='$leads_id', retailer_type_id='6'";
		$result = mysql_query($query) or die("Query failed : " . mysql_error());
	}
	if($retailer_type6 != 1 && $temp_retailer_type_id6 == 6) {
		$query = "DELETE FROM leads_type_link WHERE leads_id='$leads_id' AND retailer_type_id='6'";
		$result = mysql_query($query) or die("Query failed : " . mysql_error());
	}
	
	$query = "SELECT retailer_type_id FROM leads_type_link WHERE leads_id='$leads_id' AND retailer_type_id='7'";
	$result = mysql_query($query) or die("Query failed : " . mysql_error());
	while ($line = mysql_fetch_array($result, MYSQL_ASSOC)) {
		$temp_retailer_type_id7 = $line["retailer_type_id"];
	}
	mysql_free_result($result);
	if($retailer_type7 == 1 && $temp_retailer_type_id7 == "") {
		$now = date("Y-m-d H:i:s");
		$query = "INSERT INTO leads_type_link SET created='$now', leads_id='$leads_id', retailer_type_id='7'";
		$result = mysql_query($query) or die("Query failed : " . mysql_error());
	}
	if($retailer_type7 != 1 && $temp_retailer_type_id7 == 7) {
		$query = "DELETE FROM leads_type_link WHERE leads_id='$leads_id' AND retailer_type_id='7'";
		$result = mysql_query($query) or die("Query failed : " . mysql_error());
	}
	
	$query = "SELECT retailer_type_id FROM leads_type_link WHERE leads_id='$leads_id' AND retailer_type_id='8'";
	$result = mysql_query($query) or die("Query failed : " . mysql_error());
	while ($line = mysql_fetch_array($result, MYSQL_ASSOC)) {
		$temp_retailer_type_id8 = $line["retailer_type_id"];
	}
	mysql_free_result($result);
	if($retailer_type8 == 1 && $temp_retailer_type_id8 == "") {
		$now = date("Y-m-d H:i:s");
		$query = "INSERT INTO leads_type_link SET created='$now', leads_id='$leads_id', retailer_type_id='8'";
		$result = mysql_query($query) or die("Query failed : " . mysql_error());
	}
	if($retailer_type8 != 1 && $temp_retailer_type_id8 == 8) {
		$query = "DELETE FROM leads_type_link WHERE leads_id='$leads_id' AND retailer_type_id='8'";
		$result = mysql_query($query) or die("Query failed : " . mysql_error());
	}
	
	$query = "SELECT retailer_type_id FROM leads_type_link WHERE leads_id='$leads_id' AND retailer_type_id='9'";
	$result = mysql_query($query) or die("Query failed : " . mysql_error());
	while ($line = mysql_fetch_array($result, MYSQL_ASSOC)) {
		$temp_retailer_type_id9 = $line["retailer_type_id"];
	}
	mysql_free_result($result);
	if($retailer_type9 == 1 && $temp_retailer_type_id9 == "") {
		$now = date("Y-m-d H:i:s");
		$query = "INSERT INTO leads_type_link SET created='$now', leads_id='$leads_id', retailer_type_id='9'";
		$result = mysql_query($query) or die("Query failed : " . mysql_error());
	}
	if($retailer_type9 != 1 && $temp_retailer_type_id9 == 9) {
		$query = "DELETE FROM leads_type_link WHERE leads_id='$leads_id' AND retailer_type_id='9'";
		$result = mysql_query($query) or die("Query failed : " . mysql_error());
	}

	$query = "SELECT retailer_type_id FROM leads_type_link WHERE leads_id='$leads_id' AND retailer_type_id='10'";
	$result = mysql_query($query) or die("Query failed : " . mysql_error());
	while ($line = mysql_fetch_array($result, MYSQL_ASSOC)) {
		$temp_retailer_type_id10 = $line["retailer_type_id"];
	}
	mysql_free_result($result);
	if($retailer_type10 == 1 && $temp_retailer_type_id10 == "") {
		$now = date("Y-m-d H:i:s");
		$query = "INSERT INTO leads_type_link SET created='$now', leads_id='$leads_id', retailer_type_id='10'";
		$result = mysql_query($query) or die("Query failed : " . mysql_error());
	}
	if($retailer_type10 != 1 && $temp_retailer_type_id10 == 10) {
		$query = "DELETE FROM leads_type_link WHERE leads_id='$leads_id' AND retailer_type_id='10'";
		$result = mysql_query($query) or die("Query failed : " . mysql_error());
	}

	$query = "SELECT retailer_type_id FROM leads_type_link WHERE leads_id='$leads_id' AND retailer_type_id='11'";
	$result = mysql_query($query) or die("Query failed : " . mysql_error());
	while ($line = mysql_fetch_array($result, MYSQL_ASSOC)) {
		$temp_retailer_type_id11 = $line["retailer_type_id"];
	}
	mysql_free_result($result);
	if($retailer_type11 == 1 && $temp_retailer_type_id11 == "") {
		$now = date("Y-m-d H:i:s");
		$query = "INSERT INTO leads_type_link SET created='$now', leads_id='$leads_id', retailer_type_id='11'";
		$result = mysql_query($query) or die("Query failed : " . mysql_error());
	}
	if($retailer_type11 != 1 && $temp_retailer_type_id11 == 11) {
		$query = "DELETE FROM leads_type_link WHERE leads_id='$leads_id' AND retailer_type_id='11'";
		$result = mysql_query($query) or die("Query failed : " . mysql_error());
	}

	$query = "SELECT retailer_type_id FROM leads_type_link WHERE leads_id='$leads_id' AND retailer_type_id='12'";
	$result = mysql_query($query) or die("Query failed : " . mysql_error());
	while ($line = mysql_fetch_array($result, MYSQL_ASSOC)) {
		$temp_retailer_type_id12 = $line["retailer_type_id"];
	}
	mysql_free_result($result);
	if($retailer_type12 == 1 && $temp_retailer_type_id12 == "") {
		$now = date("Y-m-d H:i:s");
		$query = "INSERT INTO leads_type_link SET created='$now', leads_id='$leads_id', retailer_type_id='12'";
		$result = mysql_query($query) or die("Query failed : " . mysql_error());
	}
	if($retailer_type12 != 1 && $temp_retailer_type_id12 == 12) {
		$query = "DELETE FROM leads_type_link WHERE leads_id='$leads_id' AND retailer_type_id='12'";
		$result = mysql_query($query) or die("Query failed : " . mysql_error());
	}

	$query = "SELECT retailer_type_id FROM leads_type_link WHERE leads_id='$leads_id' AND retailer_type_id='13'";
	$result = mysql_query($query) or die("Query failed : " . mysql_error());
	while ($line = mysql_fetch_array($result, MYSQL_ASSOC)) {
		$temp_retailer_type_id13 = $line["retailer_type_id"];
	}
	mysql_free_result($result);
	if($retailer_type13 == 1 && $temp_retailer_type_id13 == "") {
		$now = date("Y-m-d H:i:s");
		$query = "INSERT INTO leads_type_link SET created='$now', leads_id='$leads_id', retailer_type_id='13'";
		$result = mysql_query($query) or die("Query failed : " . mysql_error());
	}
	if($retailer_type13 != 1 && $temp_retailer_type_id13 == 13) {
		$query = "DELETE FROM leads_type_link WHERE leads_id='$leads_id' AND retailer_type_id='13'";
		$result = mysql_query($query) or die("Query failed : " . mysql_error());
	}

	$query = "SELECT retailer_type_id FROM leads_type_link WHERE leads_id='$leads_id' AND retailer_type_id='14'";
	$result = mysql_query($query) or die("Query failed : " . mysql_error());
	while ($line = mysql_fetch_array($result, MYSQL_ASSOC)) {
		$temp_retailer_type_id14 = $line["retailer_type_id"];
	}
	mysql_free_result($result);
	if($retailer_type14 == 1 && $temp_retailer_type_id14 == "") {
		$now = date("Y-m-d H:i:s");
		$query = "INSERT INTO leads_type_link SET created='$now', leads_id='$leads_id', retailer_type_id='14'";
		$result = mysql_query($query) or die("Query failed : " . mysql_error());
	}
	if($retailer_type14 != 1 && $temp_retailer_type_id14 == 14) {
		$query = "DELETE FROM leads_type_link WHERE leads_id='$leads_id' AND retailer_type_id='14'";
		$result = mysql_query($query) or die("Query failed : " . mysql_error());
	}

	$query = "SELECT retailer_type_id FROM leads_type_link WHERE leads_id='$leads_id' AND retailer_type_id='15'";
	$result = mysql_query($query) or die("Query failed : " . mysql_error());
	while ($line = mysql_fetch_array($result, MYSQL_ASSOC)) {
		$temp_retailer_type_id15 = $line["retailer_type_id"];
	}
	mysql_free_result($result);
	if($retailer_type15 == 1 && $temp_retailer_type_id15 == "") {
		$now = date("Y-m-d H:i:s");
		$query = "INSERT INTO leads_type_link SET created='$now', leads_id='$leads_id', retailer_type_id='15'";
		$result = mysql_query($query) or die("Query failed : " . mysql_error());
	}
	if($retailer_type15 != 1 && $temp_retailer_type_id15 == 15) {
		$query = "DELETE FROM leads_type_link WHERE leads_id='$leads_id' AND retailer_type_id='15'";
		$result = mysql_query($query) or die("Query failed : " . mysql_error());
	}

	$query = "SELECT retailer_type_id FROM leads_type_link WHERE leads_id='$leads_id' AND retailer_type_id='16'";
	$result = mysql_query($query) or die("Query failed : " . mysql_error());
	while ($line = mysql_fetch_array($result, MYSQL_ASSOC)) {
		$temp_retailer_type_id16 = $line["retailer_type_id"];
	}
	mysql_free_result($result);
	if($retailer_type16 == 1 && $temp_retailer_type_id16 == "") {
		$now = date("Y-m-d H:i:s");
		$query = "INSERT INTO leads_type_link SET created='$now', leads_id='$leads_id', retailer_type_id='16'";
		$result = mysql_query($query) or die("Query failed : " . mysql_error());
	}
	if($retailer_type16 != 1 && $temp_retailer_type_id16 == 16) {
		$query = "DELETE FROM leads_type_link WHERE leads_id='$leads_id' AND retailer_type_id='16'";
		$result = mysql_query($query) or die("Query failed : " . mysql_error());
	}

	$query = "SELECT retailer_type_id FROM leads_type_link WHERE leads_id='$leads_id' AND retailer_type_id='17'";
	$result = mysql_query($query) or die("Query failed : " . mysql_error());
	while ($line = mysql_fetch_array($result, MYSQL_ASSOC)) {
		$temp_retailer_type_id17 = $line["retailer_type_id"];
	}
	mysql_free_result($result);
	if($retailer_type17 == 1 && $temp_retailer_type_id17 == "") {
		$now = date("Y-m-d H:i:s");
		$query = "INSERT INTO leads_type_link SET created='$now', leads_id='$leads_id', retailer_type_id='17'";
		$result = mysql_query($query) or die("Query failed : " . mysql_error());
	}
	if($retailer_type17 != 1 && $temp_retailer_type_id17 == 17) {
		$query = "DELETE FROM leads_type_link WHERE leads_id='$leads_id' AND retailer_type_id='17'";
		$result = mysql_query($query) or die("Query failed : " . mysql_error());
	}

	$query = "SELECT retailer_type_id FROM leads_type_link WHERE leads_id='$leads_id' AND retailer_type_id='18'";
	$result = mysql_query($query) or die("Query failed : " . mysql_error());
	while ($line = mysql_fetch_array($result, MYSQL_ASSOC)) {
		$temp_retailer_type_id18 = $line["retailer_type_id"];
	}
	mysql_free_result($result);
	if($retailer_type18 == 1 && $temp_retailer_type_id18 == "") {
		$now = date("Y-m-d H:i:s");
		$query = "INSERT INTO leads_type_link SET created='$now', leads_id='$leads_id', retailer_type_id='18'";
		$result = mysql_query($query) or die("Query failed : " . mysql_error());
	}
	if($retailer_type18 != 1 && $temp_retailer_type_id18 == 18) {
		$query = "DELETE FROM leads_type_link WHERE leads_id='$leads_id' AND retailer_type_id='18'";
		$result = mysql_query($query) or die("Query failed : " . mysql_error());
	}

	$query = "SELECT retailer_type_id FROM leads_type_link WHERE leads_id='$leads_id' AND retailer_type_id='19'";
	$result = mysql_query($query) or die("Query failed : " . mysql_error());
	while ($line = mysql_fetch_array($result, MYSQL_ASSOC)) {
		$temp_retailer_type_id19 = $line["retailer_type_id"];
	}
	mysql_free_result($result);
	if($retailer_type19 == 1 && $temp_retailer_type_id19 == "") {
		$now = date("Y-m-d H:i:s");
		$query = "INSERT INTO leads_type_link SET created='$now', leads_id='$leads_id', retailer_type_id='19'";
		$result = mysql_query($query) or die("Query failed : " . mysql_error());
	}
	if($retailer_type19 != 1 && $temp_retailer_type_id19 == 19) {
		$query = "DELETE FROM leads_type_link WHERE leads_id='$leads_id' AND retailer_type_id='19'";
		$result = mysql_query($query) or die("Query failed : " . mysql_error());
	}

	$query = "SELECT retailer_type_id FROM leads_type_link WHERE leads_id='$leads_id' AND retailer_type_id='20'";
	$result = mysql_query($query) or die("Query failed : " . mysql_error());
	while ($line = mysql_fetch_array($result, MYSQL_ASSOC)) {
		$temp_retailer_type_id20 = $line["retailer_type_id"];
	}
	mysql_free_result($result);
	if($retailer_type20 == 1 && $temp_retailer_type_id20 == "") {
		$now = date("Y-m-d H:i:s");
		$query = "INSERT INTO leads_type_link SET created='$now', leads_id='$leads_id', retailer_type_id='20'";
		$result = mysql_query($query) or die("Query failed : " . mysql_error());
	}
	if($retailer_type20 != 1 && $temp_retailer_type_id20 == 20) {
		$query = "DELETE FROM leads_type_link WHERE leads_id='$leads_id' AND retailer_type_id='20'";
		$result = mysql_query($query) or die("Query failed : " . mysql_error());
	}
...
if ($delete != "") {
	$query = "DELETE FROM leads WHERE leads_id='$leads_id'";
	$result = mysql_query($query) or die("Query failed : " . mysql_error());
...
if($convert != "") {
	...
	$query = "UPDATE leads SET";
	$query .= " leads_status='0'";
	$query .= " WHERE leads_id='$leads_id'";
	$result = mysql_query($query) or die("Query failed : " . mysql_error());

	$query = "SELECT created, entered_by FROM leads WHERE leads_id='$leads_id'";
	$result = mysql_query($query) or die("Query failed : sql=$query" . mysql_error());
	while ($line = mysql_fetch_array($result, MYSQL_ASSOC)) {
	...
	$query2 = "SELECT retailer_id FROM retailer WHERE created='$created'";
	...
	if($retailer_type1 == 1 && $temp_retailer_type_id1 == "") {
		$now = date("Y-m-d H:i:s");
		$query = "INSERT INTO retailer_type_link SET created='$now', retailer_id='$retailer_id', retailer_type_id='1'";
		$result = mysql_query($query) or die("Query failed : " . mysql_error());
	}
	if($retailer_type1 == 1 && $temp_retailer_type_id1 == 1) {
		$now = date("Y-m-d H:i:s");
	...
	if($retailer_type2 == 1 && $temp_retailer_type_id2 == "") {
		$now = date("Y-m-d H:i:s");
		$query = "INSERT INTO retailer_type_link SET created='$now', retailer_id='$retailer_id', retailer_type_id='2'";
		$result = mysql_query($query) or die("Query failed : " . mysql_error());
	}
	if($retailer_type2 == 1 && $temp_retailer_type_id2 == 2) {
		$now = date("Y-m-d H:i:s");
	...
	if($retailer_type3 == 1 && $temp_retailer_type_id3 == "") {
		$now = date("Y-m-d H:i:s");
		$query = "INSERT INTO retailer_type_link SET created='$now', retailer_id='$retailer_id', retailer_type_id='3'";
		$result = mysql_query($query) or die("Query failed : " . mysql_error());
	}
	if($retailer_type3 == 1 && $temp_retailer_type_id3 == 3) {
		$now = date("Y-m-d H:i:s");
	...
	if($retailer_type4 == 1 && $temp_retailer_type_id4 == "") {
		$now = date("Y-m-d H:i:s");
		$query = "INSERT INTO retailer_type_link SET created='$now', retailer_id='$retailer_id', retailer_type_id='4'";
		$result = mysql_query($query) or die("Query failed : " . mysql_error());
	}
	if($retailer_type4 == 1 && $temp_retailer_type_id4 == 4) {
		$now = date("Y-m-d H:i:s");
	...
	if($retailer_type5 == 1 && $temp_retailer_type_id5 == "") {
		$now = date("Y-m-d H:i:s");
		$query = "INSERT INTO retailer_type_link SET created='$now', retailer_id='$retailer_id', retailer_type_id='5'";
		$result = mysql_query($query) or die("Query failed : " . mysql_error());
	}
	if($retailer_type5 == 1 && $temp_retailer_type_id5 == 5) {
		$now = date("Y-m-d H:i:s");
	...
	if($retailer_type6 == 1 && $temp_retailer_type_id6 == "") {
		$now = date("Y-m-d H:i:s");
		$query = "INSERT INTO retailer_type_link SET created='$now', retailer_id='$retailer_id', retailer_type_id='6'";
		$result = mysql_query($query) or die("Query failed : " . mysql_error());
	}
	if($retailer_type6 == 1 && $temp_retailer_type_id6 == 6) {
		$now = date("Y-m-d H:i:s");
	...
	if($retailer_type7 == 1 && $temp_retailer_type_id7 == "") {
		$now = date("Y-m-d H:i:s");
		$query = "INSERT INTO retailer_type_link SET created='$now', retailer_id='$retailer_id', retailer_type_id='7'";
		$result = mysql_query($query) or die("Query failed : " . mysql_error());
	}
	if($retailer_type7 == 1 && $temp_retailer_type_id7 == 7) {
		$now = date("Y-m-d H:i:s");
	...
	if($retailer_type8 == 1 && $temp_retailer_type_id8 == "") {
		$now = date("Y-m-d H:i:s");
		$query = "INSERT INTO retailer_type_link SET created='$now', retailer_id='$retailer_id', retailer_type_id='8'";
		$result = mysql_query($query) or die("Query failed : " . mysql_error());
	}
	if($retailer_type8 == 1 && $temp_retailer_type_id8 == 8) {
		$now = date("Y-m-d H:i:s");
	...
	if($retailer_type9 == 1 && $temp_retailer_type_id9 == "") {
		$now = date("Y-m-d H:i:s");
		$query = "INSERT INTO retailer_type_link SET created='$now', retailer_id='$retailer_id', retailer_type_id='9'";
		$result = mysql_query($query) or die("Query failed : " . mysql_error());
	}
	if($retailer_type9 == 1 && $temp_retailer_type_id9 == 9) {
		$now = date("Y-m-d H:i:s");
	...
	if($retailer_type10 == 1 && $temp_retailer_type_id10 == "") {
		$now = date("Y-m-d H:i:s");
		$query = "INSERT INTO retailer_type_link SET created='$now', retailer_id='$retailer_id', retailer_type_id='10'";
		$result = mysql_query($query) or die("Query failed : " . mysql_error());
	}
	if($retailer_type10 == 1 && $temp_retailer_type_id10 == 10) {
		$now = date("Y-m-d H:i:s");
	...
	if($retailer_type11 == 1 && $temp_retailer_type_id11 == "") {
		$now = date("Y-m-d H:i:s");
		$query = "INSERT INTO retailer_type_link SET created='$now', retailer_id='$retailer_id', retailer_type_id='11'";
		$result = mysql_query($query) or die("Query failed : " . mysql_error());
	}
	if($retailer_type11 == 1 && $temp_retailer_type_id11 == 11) {
		$now = date("Y-m-d H:i:s");
	...
	if($retailer_type12 == 1 && $temp_retailer_type_id12 == "") {
		$now = date("Y-m-d H:i:s");
		$query = "INSERT INTO retailer_type_link SET created='$now', retailer_id='$retailer_id', retailer_type_id='12'";
		$result = mysql_query($query) or die("Query failed : " . mysql_error());
	}
	if($retailer_type12 == 1 && $temp_retailer_type_id12 == 12) {
		$now = date("Y-m-d H:i:s");
	...
	if($retailer_type13 == 1 && $temp_retailer_type_id13 == "") {
		$now = date("Y-m-d H:i:s");
		$query = "INSERT INTO retailer_type_link SET created='$now', retailer_id='$retailer_id', retailer_type_id='13'";
		$result = mysql_query($query) or die("Query failed : " . mysql_error());
	}
	if($retailer_type13 == 1 && $temp_retailer_type_id13 == 13) {
		$now = date("Y-m-d H:i:s");
	...
	if($retailer_type14 == 1 && $temp_retailer_type_id14 == "") {
		$now = date("Y-m-d H:i:s");
		$query = "INSERT INTO retailer_type_link SET created='$now', retailer_id='$retailer_id', retailer_type_id='14'";
		$result = mysql_query($query) or die("Query failed : " . mysql_error());
	}
	if($retailer_type14 == 1 && $temp_retailer_type_id14 == 14) {
		$now = date("Y-m-d H:i:s");
	...
	if($retailer_type15 == 1 && $temp_retailer_type_id15 == "") {
		$now = date("Y-m-d H:i:s");
		$query = "INSERT INTO retailer_type_link SET created='$now', retailer_id='$retailer_id', retailer_type_id='15'";
		$result = mysql_query($query) or die("Query failed : " . mysql_error());
	}
	if($retailer_type15 == 1 && $temp_retailer_type_id15 == 15) {
		$now = date("Y-m-d H:i:s");
	...
	if($retailer_type16 == 1 && $temp_retailer_type_id16 == "") {
		$now = date("Y-m-d H:i:s");
		$query = "INSERT INTO retailer_type_link SET created='$now', retailer_id='$retailer_id', retailer_type_id='16'";
		$result = mysql_query($query) or die("Query failed : " . mysql_error());
	}
	if($retailer_type16 == 1 && $temp_retailer_type_id16 == 16) {
		$now = date("Y-m-d H:i:s");
	...
	if($retailer_type17 == 1 && $temp_retailer_type_id17 == "") {
		$now = date("Y-m-d H:i:s");
		$query = "INSERT INTO retailer_type_link SET created='$now', retailer_id='$retailer_id', retailer_type_id='17'";
		$result = mysql_query($query) or die("Query failed : " . mysql_error());
	}
	if($retailer_type17 == 1 && $temp_retailer_type_id17 == 17) {
		$now = date("Y-m-d H:i:s");
	...
	if($retailer_type18 == 1 && $temp_retailer_type_id18 == "") {
		$now = date("Y-m-d H:i:s");
		$query = "INSERT INTO retailer_type_link SET created='$now', retailer_id='$retailer_id', retailer_type_id='18'";
		$result = mysql_query($query) or die("Query failed : " . mysql_error());
	}
	if($retailer_type18 == 1 && $temp_retailer_type_id18 == 18) {
		$now = date("Y-m-d H:i:s");
	...
	if($retailer_type19 == 1 && $temp_retailer_type_id19 == "") {
		$now = date("Y-m-d H:i:s");
		$query = "INSERT INTO retailer_type_link SET created='$now', retailer_id='$retailer_id', retailer_type_id='19'";
		$result = mysql_query($query) or die("Query failed : " . mysql_error());
	}
	if($retailer_type19 == 1 && $temp_retailer_type_id19 == 19) {
		$now = date("Y-m-d H:i:s");
	...
	if($retailer_type20 == 1 && $temp_retailer_type_id20 == "") {
		$now = date("Y-m-d H:i:s");
		$query = "INSERT INTO retailer_type_link SET created='$now', retailer_id='$retailer_id', retailer_type_id='20'";
		$result = mysql_query($query) or die("Query failed : " . mysql_error());
	}
	if($retailer_type20 == 1 && $temp_retailer_type_id20 == 20) {
		$now = date("Y-m-d H:i:s");
	...
	// Send to retailers admin modify retailer page
	header("Location: " . $base_url . "admin/retailers_admin4.php?edit=".$retailer_id);
	exit;
}

$query = "SELECT * FROM leads WHERE leads_id='$edit'";
$result = mysql_query($query) or die("Query failed : " . mysql_error());
while ($line = mysql_fetch_array($result, MYSQL_ASSOC)) {
	...
	$where_store_found = stripslashes($line["where_store_found"]);
	$comments = stripslashes($line["comments"]);
}
mysql_free_result($result);

	if($edit != "") { $leads_id = $edit; }
?>
...
<tr><td align="left"><font size="2">Edit the Lead below.</font></td></tr>
...
<tr><td align="left"><font size="2"><b>Modify Lead Form</b></font></td></tr>

<form name="form1" action="./leads_admin4.php" method="POST">
<input type="hidden" name="leads_id" value="<?php echo $edit; ?>">
<tr><td align="left"><table border="0">
<tr><td align="right"><font face="Arial" size="+1">Store Name:</font></td><td><input type="text" name="store_name" size="30" maxlength="255" value="<?php echo $store_name; ?>"></td></tr>
<tr><td align="right"><font face="Arial" size="+1">Contact Name:</font></td><td><input type="text" name="contact_name" size="30" maxlength="150" value="<?php echo $contact_name; ?>"></td></tr>
...
<tr><td align="right"><font face="Arial" size="+1">Comment and Notes Section:</font></td><td><TEXTAREA name="comments" cols="40" rows="7"><?php echo $comments; ?></TEXTAREA></td></tr>

<tr><td colspan="2" align="center"><input type="submit" name="submit" value=" Modify Lead ">
<?php
if($this_user_id == 1 || $this_user_id == 2 || $this_user_id == 5 || $this_user_id == 6 || $this_user_id == 7 || $this_user_id == 8 || $this_user_id == 9) { 
?>
	&nbsp; <input type="submit" name="delete" value=" Delete Lead " onClick="return warn_on_submit()">
<?php
}
if($this_user_id == 1 || $this_user_id == 2 || $this_user_id == 5 || $this_user_id == 6 || $this_user_id == 7 || $this_user_id == 8 || $this_user_id == 9) {
?>
	&nbsp; <input type="submit" name="convert" value="Convert This Lead To Retailer">
<?php
}
?>
</td></tr>
